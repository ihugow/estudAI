      ...
      <div className="bg-box/70 p-5 rounded-xl shadow-md overflow-hidden h-full transform transition-transform duration-300 border border-cinza-ardosia group-hover:shadow-xl group-hover:-translate-y-1">
        <div className="flex gap-3 items-center">
          <img
                ...
                alt={post.authorName}
                className="size-18 rounded-full mr-2 object-cover"
              />
              <div className="flex flex-col gap-2">
                <span className="text-white font-semibold text-lg">{post.authorName}</span>
                <span className="text-white text-sm border border-white w-fit px-2 rounded-lg">Seguir</span>
              </div>
        </div>
