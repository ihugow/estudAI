...
const SideBar = ({ onClose, isOpen }) => {
  return (
    <div className={`${style.sidebar} fixed top-0 right-0 w-56 h-screen bg-zinc-900 text-white p-5 z-50 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
